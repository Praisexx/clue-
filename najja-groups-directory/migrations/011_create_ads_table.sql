...
-- Add comments
COMMENT ON TABLE advertisements IS 'Nigerian business advertisements and sponsored content';
COMMENT ON COLUMN advertisements.target_countries IS 'Array of countries where this ad should be shown';
COMMENT ON COLUMN advertisements.target_cities IS 'Array of cities where this ad should be shown';
COMMENT ON COLUMN advertisements.priority IS 'Higher numbers get shown more frequently';
COMMENT ON TABLE ad_clicks IS 'Tracks individual clicks on advertisements';